package com.example.jetpackpro.view.home.content.tvshows
...
class TvShowsFragment(var page: Int, var title: String) : Fragment(),
    Callback {
    ...
    companion object {
        @JvmStatic
        fun newInstance(page: Int, title: String): TvShowsFragment {
            return TvShowsFragment(page, title)
        }
    }
    ...
    private fun setupRecyclerView(data: List<DataModel>) {
        rv_tvshows.apply {
            ...
            adapter = Adapter(this@TvShowsFragment)
        }.also {
